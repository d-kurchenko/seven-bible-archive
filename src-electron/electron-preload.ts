...
import { CreateCategoryArgs, DeleteCategoryArgs, GetPreparedCategoriesArgs } from "types/api-args/categories";
...
export const API = {
  ...
  electron: {
    ...
    downloadModules: (modules: Download[]) => ipcRenderer.invoke('download-modules', modules)
  },
  ...
  system: {
    ...
    getModulesRegistry: (): Promise<ModulesRegistry> => ipcRenderer.invoke('get-modules-registry'),
    getInstalledModules: (): Promise<Download[]> => ipcRenderer.invoke('get-installed-modules')
  },
