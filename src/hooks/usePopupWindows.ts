...
export const initPopupWindows = () => {
  ...
  const popup: Popup = {
    ...
    showTranslationsComparator: (props) =>
      showPopup(TranslationsComparator, props),
    ...
    showCrossreferencesSearcher: (props) =>
      showPopup(CrossreferencesSearcher, props),
    showCommentariesComparator: (props) =>
      showPopup(CommentariesComparator, props),
